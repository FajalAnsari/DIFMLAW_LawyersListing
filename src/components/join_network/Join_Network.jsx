  ...
  return (
       ...
       <div className='row bg-white  rounded-3 legal_network shadow me-2'>
        ...
        <div className='col-lg-6 text-center col-xs-6 mt-3'>
         <Link to="/signup"><button className='btn btn-primary cont mt-4 h-50 w-50 reg_btn sfcs'>Register as a Lawyer</button></Link> 
         <Link to="/signup"><button className='btn btn-primary cont mt-4  w-50 h-50 reg_btn sfcs'>Register as a User</button></Link>
          </div>
       </div>
