        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content border border-prime border-3" >
            ...
            <div className="mx-auto mb-4">
              <button className="btn btns-primary"  data-bs-target={!submitted ? '#exampleModalToggle' : '#exampleModalToggle2'} data-bs-toggle="modal" data-bs-dismiss="modal" onClick={() => sendEmails()}>Submit</button>
            </div>
          </div>
        </div>
      </div>
