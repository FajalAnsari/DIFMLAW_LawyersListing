...
const About_us = () => {
  return (
   ...
   <div className='container'>
        ...
        <h2 className='text-center fw-bold mt-5 font-color'>About Us</h2>
        ...
        <div className='row'>
            <div className='col-lg-6 col-12'>
            <img src={user_friendly} className='w-75 frend' alt='user_friendly' style={{marginLeft:"12%"}}></img>
            </div>
            <div className='col-lg-6 col-12'> 
        ...
        <div className='row ab-1'>
            ...
            <div className='col-lg-6 col-12'>
             <img src={user_needs} className='w-75' style={{marginTop:"-50px", marginLeft:"10%"}} alt='user_needs'></img>
            </div>
        </div>

        <div className='row'>
            <div className='col-lg-6 col-12 mt-4'>
            <img src={our_promises} className=' h-75 frend' style={{width:"140%", marginLeft:"-20%"}} alt='our_promises'></img>
            </div>
            <div className='col-lg-6 col-12'> 
